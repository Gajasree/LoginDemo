...
<meta http-equiv="refresh" content="4.5; url='home.jsp'" >  
<link href="./css/stylesheet.css" rel="stylesheet" type="text/css" media="all">
 ...
 <div class="header">
   ...
   <div class="navbar">
       <ul>
        ...
        <p style="text-align: center;"> <img src="circle.gif" width="90px" > </p>
        <h2 style="text-align: center;">  Admin Login Successful! Welcome!</h2>

 <p style="text-align: center;"> <img src="catyes.gif" width="300px" > </p>
