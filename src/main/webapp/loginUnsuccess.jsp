 ...
 <div class="header">
   ...
   <div class="navbar">
       <ul>
        ...
        <p style="text-align: center;"> <img src="cross.gif" width="130px" > </p>
        <h2 style="text-align: center ;"> Login Failed. Please try again! </h2>
      
 <p style="text-align: center;"> <img src="dogno.gif" width="330px" > </p>
<footer>
